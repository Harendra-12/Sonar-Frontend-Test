...
function InitiateCall({ from, to, name, setCalling, meetingPage, interCallMinimize, setInterCallMinimize }) {
    ...
    return (
        <>
            {token ? <LiveKitConference token={token} serverUrl={serverUrl} roomName={roomName} username={name} isAdmin={true} setCalling={setCalling} meetingPage={meetingPage} isMinimize={interCallMinimize}
