...
const UsersAdd = () => {
    ...
    useEffect(()=>{
        if(account===null){
            ...
            async function getDomain(){
                const domain = await generalGetFunction(`/domain/search?account=${account.account_id}`)
                const timeZ = await generalGetFunction(`/auth/timezones`)
                const apiGroup = await generalGetFunction(`/groups`)
                if(domain.status){
                    setDomains(domain.data.map((item)=>{
                        return(
                           [item.id ,item.domain_name]
                        )
                    }))
                }else{
                    navigate("/")
                ...
                if(timeZ.status){
                    setTimeZone(timeZ.data.map((item)=>{
                        return(
                            [item.id,item.name]
                        )
                    }))
                ...
                if(apiGroup.status){
                    setGroup(apiGroup.data.map((item)=>{
   ...
   async function handleSubmit(){
        ...
        if(userState.timeZone==="" || userState.timeZone==="Select Time Zone"){
            setUserState(prevState=>({
                ...prevState,
        ...
        if(userState.organization.length>3 && userState.organization.length<50){
            setUserState(prevState=>({
                ...prevState,
                organizationMissing:false
            }))
        ...
        if(userState.userName.length>3 && userState.userName.length<20 && userState.password.length>3 && userState.password === userState.cPassword && userState.email.length>3 && userState.email.includes("@")  && !(userState.timeZone==="" || userState.timeZone==="Select Time Zone") && !(userState.status==="" || userState.status==="Choose Status") && !(userState.groups==="" || userState.groups==="Choose Group") && !(userState.type==="" || userState.type==="Choose Type") && !(userState.domain==="" || userState.domain==="Choose Domain")  && userState.firstName.length>3 && userState.firstName.length<20 && userState.isUserNameAvailable ){
            console.log("All consdition verified !");
            const parsedData ={
                                ...
                                <form action="#" className="row">
                                    ...
                                    <div className="formRow col-xl-3">
                                        <div className="formLabel">
                                            ...
                                            {userState.emailMissing?<label className='status missing'>Invalid Email</label>:""}
                                        </div>
                                        <div className="col-12">
                                            <input
                                                type="email"
                                    ...
                                    <div className="formRow col-xl-3">
                                        <div className="formLabel">
                                            ...
                                            {userState.firstNameMissing?<label className='status missing'>Invalid Name</label>:""}
                                        </div>
                                        <div className="col-12">
                                            <input
                                                type="text"
                                    ...
                                    <div className="formRow col-xl-3">
                                        <div className="formLabel">
                                            ...
                                            {userState.timeZoneMissing?<label className='status missing'>Select Timezone</label>:""}
                                        </div>
                                        <div className="col-12">
                                            <select className="formItem" name="" value={userState.timeZone} onChange={(e) => {
                                                setUserState(prevState => ({
                                                    ...prevState,
                                    ...
                                    <div className="formRow col-xl-3">
                                        <div className="formLabel">
                                            ...
                                            {userState.statusMissing?<label className='status missing'>Select Status</label>:""}
                                        </div>
                                        <div className="col-12">
                                            <select className="formItem" name="" value={userState.status} onChange={(e) => {
                                                setUserState(prevState => ({
                                                    ...prevState,
                                    ...
                                    <div className="formRow col-xl-3">
                                        <div className="formLabel">
                                            ...
                                            {userState.groupMissing?<label className='status missing'>Select Group</label>:""}
                                        </div>
                                        <div className="col-12">
                                            <select className="formItem" name="" value={userState.groups} onChange={(e) => {
                                                setUserState(prevState => ({
                                                    ...prevState,
                                    ...
                                    <div className="formRow col-xl-3">
                                        <div className="formLabel">
                                            ...
                                            {userState.typeMissing?<label className='status missing'>Select Type</label>:""}
                                        </div>
                                        <div className="col-12">
                                            <select className="formItem" name="" value={userState.type} onChange={(e) => {
                                                setUserState(prevState => ({
                                                    ...prevState,
                                                    type: e.target.value
                                                }))
                                    ...
                                    <div className="formRow col-xl-3">
                                        <div className="formLabel">
                                            ...
                                            {userState.domainMissing?<label className='status missing'>Select Domain</label>:""}
                                        </div>
                                        <div className="col-12">
                                            <select className="formItem" name="" value={userState.domain} onChange={(e) => {
                                                setUserState(prevState => ({
                                                    ...prevState,
