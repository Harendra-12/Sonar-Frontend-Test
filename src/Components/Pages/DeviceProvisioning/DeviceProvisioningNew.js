...
function DeviceProvisioningNew() {
  ...
  const [deviceType, setDeviceType] = useState("desktopPhone");
  ...
  function handelModelSelect(id) {
    if ((deviceType === "desktopPhone" && modelId === "") || brandId !== id) {
                        ...
                        <nav>
                          ...
                          >
                            <button
                              ...
                              id="nav-desk-tab"
                              data-bs-toggle="tab"
                              data-bs-target="#nav-desk"
                              type="button"
                              role="tab"
                              aria-controls="nav-desk"
                              aria-selected="true"
                              onClick={() => {
                                setDeviceType("desktopPhone");
                                setModelId("");
                              }}
                            >
                              Desktop Phones
                            ...
                            <button
                              ...
                              id="nav-soft-tab"
                              data-bs-toggle="tab"
                              data-bs-target="#nav-soft"
                              type="button"
                              role="tab"
                              aria-controls="nav-soft"
                              aria-selected="false"
                              onClick={() => {
                          ...
                          >
                            <div className="row col-12 mx-auto mb-0">
                              {allDevices.map((device, index) => {
                                return (
                                  <div
                                    className="formRow col-xl-6 deviceProvision flex-nowrap"
                                    key={index}
                                  >
                                    <div className="col-4">
                                      <img
                                        src={require("../../assets/images/cisco.jpg")}
                                        alt=""
                                      ></img>
                                    </div>
                                    <div className="col-8">
                          ...
                          >
                            <div className="row col-12 mx-auto mb-0">
                              ...
                              <div className="formRow col-xl-6 deviceProvision">
                                <div className="col-4">
                                  <img
                                    src={require("../../assets/images/webrtc.png")}
                                    alt=""
                                  ></img>
                                </div>
                                <div className="formLabel ">
                        ...
                        <form>
                          ...
                          <div className="formRow">
                            ...
                            {errors.serial_number && (
                              <ErrorMessage
                                text={errors.serial_number.message}
                              />
                            )}
                          </div>
                          <div className="formRow">
