...
const NewGetDid = () => {
  ...
  const handleChangeUsage = (e) => {
    ...
    setSelectedUsage((prev) => {
      let newSelection = prev.filter(
        (item) => item.value != updatedValue.value
      );
      if (checked) {
      ...
      return [
        nonRemovable,
        ...newSelection.filter((item) => item.value !== "voice"),
      ];
    });
  };
  ...
  async function handlePayment() {
    ...
    if (paymentMethod === "wallet") {
      const parsedData = {
        ...
        accountId: selectedDid.find((item) => item.vendorAccountId)
          ?.vendorAccountId,
                        ...
                        {watch().country ? (
                          <>
                            <div style={{ padding: "0px 23px 20px" }}>
                              ...
                              >
                                ...
                                <div className="formRow col-xl-2 col-lg-3 col-md-3 col-sm-6 col-6">
                                  ...
                                  <div className="col-12">
                                    ...
                                    {errors.searchType && (
                                      <ErrorMessage
                                        text={errors.searchType.message}
                                      />
                                    )}
                                    <label
                                      htmlFor="data"
                                  ...
                                  <>
                                    ...
                                    >
                                      ...
                                      <div className="col-12">
                                        ...
                                        >
                                          <option value="npa">
                                            First 3 Digit (Area Code)
                                          </option>
                                          <option value="npanxx">
                                            First 6 Digits (Area + Exchange
                                            Code)
                                          </option>
                                          <option value="ratecenter">
                                            Rate Center
                                          </option>
                                        </select>
                                        {errors.searchBy && (
                                          <ErrorMessage
                                            text={errors.searchBy.message}
                                          />
                                        )}
                                        <label
                                          htmlFor="data"
                                    ...
                                    <>
                                      ...
                                      >
                                        <div
                                          ...
                                          style={{ width: "100%" }}
                                        >
                                          <label htmlFor="rateCenter">
                                            Rate Center
                                          </label>
                                          {errors.rateCenter && (
                                            <ErrorMessage
                                              text={errors.rateCenter.message}
                                            />
                                          )}
                                        </div>
                                        <div className="col-12">
                                      ...
                                      >
                                        ...
                                        <div className="col-12">
                                          ...
                                          {errors.contiguous && (
                                            <ErrorMessage
                                              text={errors.contiguous.message}
                                            />
                                          )}
                                          <label
                                            htmlFor="data"
                                ...
                                <div className="formRow col-auto">
                                  <div className="">
                                    ...
                                    >
                                      Search
                                      <i className="fa-regular fa-magnifying-glass ms-2"></i>
                                    </button>
                                  </div>
                                </div>
                              </form>
                                    ...
                                    >
                                      <div className="card-body flex-row gap-3 justify-content-start w-100">
                                        ...
                                        <div className="card_details">
                                          <p className="country_name text-start">
                                            {item.friendly_name
                                              ? item.friendly_name
                                              : item.didSummary}
                                          </p>
                              ...
                              {selectedDid && selectedDid.length > 0 && (
                                <div className="py-2">
                                  <button
            ...
            <div className="addNewContactPopup">
              <div className="row">
                <div className="col-12 heading">
                  ...
                  <p>You are about to purchase the selected number</p>
                ...
                <div>
                  ...
                  <div className="border border-light-subtle rounded-3 p-2 mb-2">
                    <div>
                      <ul>
                    ...
                    <ul className="d-flex justify-content-start flex-column border border-light-subtle rounded-3 p-2">
                      <div className="d-flex justify-content-between align-items-center gap-2 mb-2">
                        <li className="my-0 col mb-0 position-relative">
                          ...
                          Wallet{" "}
                          <span
                            style={{ float: "inline-end", fontSize: "14px" }}
                          >
                            ${accountBalance}
                          </span>
                          <input
                        ...
                        {totalPrice > Number(accountBalance) ? (
                ...
                <div className="col-xl-12 mt-4">
                  <div className="d-flex justify-content-between">
                    <button
                      ...
                      onClick={() => setPurchaseDidPopup(false)}
                    >
