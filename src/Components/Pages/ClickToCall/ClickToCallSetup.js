                                                                    ...
                                                                    <div className="clickToCallModule mb-3">
                                                                        <div className="clickToCallHeader">
                                                                            <div className="wrapper">
                                                                                ...
                                                                                <div className="text">
                                                                                    <h5>AnglePBX</h5>
                                                                                    <p>
                                                                                        Business Phone System | Cloud
                                                                                        Contact Center | Cloud PBX
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div className="clickToCallBody">
                                                                            <div className="callByAudio">
                                                                                ...
                                                                                <h5>
                                                                                    Arrange an <span>Audio Call</span>{" "}
                                                                                    with our Agent
                                                                                </h5>
                                                                            </div>
                                                                            <div className="callByVideo">
                                                                                ...
                                                                                <h5>
                                                                                    Arrange a <span>Video Call</span> with
                                                                                    our Agent
                                                                                </h5>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="clickToCallButton">
                                    ...
                                    <div className="d-flex flex-wrap">
                                        <div className="col-12">
                                            <div className="heading">
                                                <div className="content">
                                                    ...
                                                    <p>Setup your click to call widget in realtime.</p>
                                                </div>
                                                <div className="buttonGroup">
                                                    <button
                                                        onClick={() => {
                                        ...
                                        >
                                            <form>
                                                ...
                                                <div
                                                    className="formRow col-xl-3 pt-3"
                                                    style={{ borderTop: "1px solid var(--border-color)" }}
                                                >
                                                    <div className="formLabel">
                                                        <label htmlFor="">Copy embeded code</label>
                                                        <label htmlFor="data" className="formItemDesc">
                                                            Copy this code and drop it in your website (above
                                                            closing body tag) to install click to call widget.
                                                        </label>
                                                    </div>
                                                    <div className="col-6">
                                                        <textarea
