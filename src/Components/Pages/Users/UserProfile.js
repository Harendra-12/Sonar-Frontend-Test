                      ...
                      <div className="card-body ">
                        <div className="row">
                          <div className="col-xl-4 col-lg-5 col-md-5 mb-2">
                            <div className="card mb-0 border-0 shadow_sm">
                                      ...
                                      <div className="w-100 ">
                                        ...
                                        <div className="content mt-1 d-flex align-items-center justify-content-center">
                                          {/* <div className="profileicons">
                                                <i className="fa-regular me-2 fa-user"></i>
                                              </div> */}
                                        </div>
                                        <div className="content mt-1  d-flex align-items-center justify-content-center">
                                          <div className="profileicons">
                          ...
                          <div className="col-xl-8 col-lg-7 col-md-7">
                            <div className="card shadow_sm border-0">
                              <div className="card-body">
                                {loading ? (
                                  <>
                                    <CircularLoader />
            ...
            <div className="overviewTableChild">
              ...
              <div className="d-flex flex-wrap">
                ...
                >
                  <div className="profileView">
                    <div className="profileDetailsHolder p-0 shadow-none">
                      <div className="baseDetails d-block p-1">
                        <div className="pro_bg">
                          <img
                            src={require('../../assets/images/profile-bg.jpg')} alt="profile-bg" />
                        </div>
                        <div className="card profile_info border-0 ">
                          <div className="card-body pb-0">
                            <div className="row">
