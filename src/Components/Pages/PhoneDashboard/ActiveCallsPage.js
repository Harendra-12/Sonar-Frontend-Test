                                    ...
                                    <PanelGroup autoSaveId="example" direction="horizontal">
                                        ...
                                        <Panel className='rightPanel' defaultSize={40} collapsible={true} minSize={25} ref={rightPanel}>
                                            <div className='activeCallsAgentWrapper position-relative'>
                                                ...
                                                {!isParentWebRtc && <AllActiveAgentStatus isActiveCallsPage={true} />}
                                                <div className={!isParentWebRtc && 'callDashParkedCalls extra'} style={!isParentWebRtc ? { transform: isActiveAgentsOpen ? 'translate(0, -50%)' : 'translate(98%, -50%)' } : undefined}>
                                                    {!isParentWebRtc && <button onClick={() => setIsActiveAgentsOpen(!isActiveAgentsOpen)} className="callDashParkedCallsBtn">
