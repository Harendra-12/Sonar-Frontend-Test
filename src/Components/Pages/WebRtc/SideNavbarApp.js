    ...
    <div id="sidenNavApp">
      <div className="sidenavItems">
        <ul>
          ...
          <li
            effect="ripple"
            onclick="window.location='<?php echo base_url('user-app-messages'); ?>'"
          >
            <button>
          ...
          <li
            effect="ripple"
            onclick="window.location='<?php echo base_url('user-app-call'); ?>'"
          >
            <button>
              <div className="iconHolder">
          ...
          <li
            effect="ripple"
            onclick="window.location='<?php echo base_url('user-app-voicemails'); ?>'"
          >
            <button>
              <div className="iconHolder">
          ...
          <li
            effect="ripple"
            onclick="window.location='<?php echo base_url('user-app-favorites'); ?>'"
          >
            <button>
              <div className="iconHolder">
          ...
          <li
            effect="ripple"
            onclick="window.location='<?php echo base_url('user-app-contact'); ?>'"
          >
            <button>
              <div className="iconHolder">
          ...
          <li
            effect="ripple"
            onclick="window.location='<?php echo base_url('conference-login'); ?>'"
          >
            <button>
              <div className="iconHolder">
