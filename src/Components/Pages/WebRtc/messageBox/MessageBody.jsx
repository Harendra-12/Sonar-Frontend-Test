      ...
      <div className="d-flex h-100 smBlock">
                    ...
                    {selectedChat === "groupChat" ? (
                      ...
                      <div className="dropdown ms-1">
                        <span
                          ...
                          ref={tagDropdownRef}
                        >
                          <i className="fa-solid fa-circle-plus me-1"></i> Add
                          tag
                        </span>
                        <ul
            ...
            <div className="messageContent position-relative">
              ...
              {pageLoader && (
                <div className="loadingBody">
                  <div
                    className="spinner-border text-spinner-secondary"
                    role="status"
                  >
              ...
              {allMessage[recipient[0]]?.length > 0 &&
                (() => {
                  const pinnedMessage = allMessage[recipient[0]].find(
                    (msg) => msg?.is_pinned == 1
                  );
                ...
                {recipient?.[0] ? (
                  <>
                    {allMessage?.[
                      ...
                      const todayDate = formatDateTime(new Date()).split(
                        " "
                        ...
                        <React.Fragment key={index}>
                          {isNewDate && (
                            <div
                              ...
                              ref={(el) => (dateHeaderRefs.current[index] = el)}
                            >
                              <p>
                          ...
                          {(
                            ...
                            <div
                              className={`messageItem sender active-${item?.id}`}
                            >
                            ...
                            <div
                              className={`messageItem receiver active-${item?.id}`}
                            >
                              <div className="second">
        ...
        {manageGroupChat ? (
            ...
            <div className="messageOverlay">
              <div className="contactHeader" style={{ height: "71px" }}>
                ...
                <div className="d-flex my-auto">
                  <button
                    className="clearButton2 "
                    onClick={() => setSaveEditToggleGroupNameChange(true)}
                  >
                        ...
                        >
                          <div className="row justify-content-between">
                            <div className="col-xl-12 d-flex">
                              ...
                              {item.email !== account.email && isAdmin ? (
          ...
          <div
            ...
            style={{
              width:
                isActiveAgentsOpen && recipient && recipient?.length > 0
                  ? "30%"
                  : "0%",
              transition: "all 0.4s ease-in-out",
            }}
