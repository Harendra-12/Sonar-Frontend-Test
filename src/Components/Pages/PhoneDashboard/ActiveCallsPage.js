                                                ...
                                                <>
                                                    <nav className='tangoNavs activeCallTabMinWidth'>
                                                        <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                                            ...
                                                            <button onClick={() => setFilter("did")} className="nav-link" id="nav-did-tab" data-bs-toggle="tab" data-bs-target="#nav-did" type="button" role="tab" aria-controls="nav-did" aria-selected="false">Number
