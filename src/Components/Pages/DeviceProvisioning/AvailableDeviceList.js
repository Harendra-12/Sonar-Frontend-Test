...
function AvailableDeviceList({ header = true, extensionData }) {
  ...
  useEffect(() => {
    if (selectDeviceEdit === "soft") {
      setSoftphoneName(
        provesionDevice.filter((device) => device.id === selectedDdeviceIs)[0]
          ?.authorisation_name
      );
    }
  }, [selectDeviceEdit]);
  ...
  const updateSoftphone = async () => {
    if (softphoneName === undefined || softphoneName === "") {
      toast.error("Softphone name is required");
      return;
    }
    setLoading(true);
    const apiData = await generalPutFunction(
      `/provision/update/${selectedDdeviceIs}`,
      { authorisation_name: softphoneName }
    );
    if (apiData.status) {
      toast.success(apiData.message);
      setRefresh(refresh + 1);
                        ...
                        <form>
                          <div className="formRow">
                            ...
                            <div className="col-6">
                              <input
                                ...
                                value={
                                  allDevices.filter(
                                    (device) => device.id === selectedBrand
                                  )[0]?.name
                                }
                                disabled
                              />
                          ...
                          <div className="formRow">
                            <div className="formLabel">
                              ...
                              <label htmlFor="data" className="formItemDesc">
                                Please enter the Serial Number of the selected
                                device
                              </label>
                            </div>
                            <div className="col-6">
                    ...
                    {selectDeviceEdit === "soft" && (
                      <div className="col-xl-6">
                        <form>
                          <div className="formRow">
                            ...
                            <div className="col-6">
                              <input
                                ...
                                value={softphoneName}
                                onChange={(e) =>
                                  setSoftphoneName(e.target.value)
                                }
                              />
                            </div>
                          </div>
                          <div className="formRow">
                            ...
                            <div className="col-6">
                              <input
                                ...
                                className="formItem"
                                value={
                                  provesionDevice.filter(
                                    (device) => device.id === selectedDdeviceIs
                                  )[0]?.address
                                }
                                disabled
                              />
                          ...
                          <div className="formRow">
                            <div className="formLabel">
                              <label className="text-dark">Device Domain</label>
                              {/* <label htmlFor="data" className="formItemDesc">
                                Please enter a name for this devices
                              </label> */}
                            </div>
