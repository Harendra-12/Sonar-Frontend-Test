    ...
    if (newAgent) {
      ...
      if (llmData.status) {
        ...
        const agentParsedData = {
          ...
          voice_temperature: Number(voice_temperature),
          voice_speed: Number(voice_speed),
          ...
          reminder_trigger_ms: Number(reminder_trigger_ms),
          reminder_max_count: reminder_max_count,
          ambient_sound: ambient_sound,
          ambient_sound_volume: Number(ambient_sound_volume),
          language: language,
          ...
          end_call_after_silence_ms: Number(end_call_after_silence_ms),
          max_call_duration_ms: Number(max_call_duration_ms),
...
const countryData = [
  { language: "English (US)", country: "United States", country_code: "US", locale: "en-US" },
  { language: "English (IN)", country: "India", country_code: "IN", locale: "en-IN" },
  { language: "English (GB)", country: "United Kingdom", country_code: "GB", locale: "en-GB" },
  { language: "English (AU)", country: "Australia", country_code: "AU", locale: "en-AU" },
  { language: "English (NZ)", country: "New Zealand", country_code: "NZ", locale: "en-NZ" },
  { language: "German", country: "Germany", country_code: "DE", locale: "de-DE" },
  { language: "Spanish", country: "Spain", country_code: "ES", locale: "es-ES" },
  { language: "Spanish (LatAm)", country: "Latin America", country_code: "419", locale: "es-419" },
  { language: "Hindi", country: "India", country_code: "IN", locale: "hi-IN" },
  { language: "French", country: "France", country_code: "FR", locale: "fr-FR" },
  { language: "French (Canada)", country: "Canada", country_code: "CA", locale: "fr-CA" },
  { language: "Japanese", country: "Japan", country_code: "JP", locale: "ja-JP" },
  { language: "Portuguese", country: "Portugal", country_code: "PT", locale: "pt-PT" },
  { language: "Portuguese (Brazil)", country: "Brazil", country_code: "BR", locale: "pt-BR" },
  { language: "Chinese (Mandarin)", country: "China", country_code: "CN", locale: "zh-CN" },
  { language: "Russian", country: "Russia", country_code: "RU", locale: "ru-RU" },
  { language: "Italian", country: "Italy", country_code: "IT", locale: "it-IT" },
  { language: "Korean", country: "South Korea", country_code: "KR", locale: "ko-KR" },
  { language: "Dutch", country: "Netherlands", country_code: "NL", locale: "nl-NL" },
  { language: "Dutch (Belgium)", country: "Belgium", country_code: "BE", locale: "nl-BE" },
  { language: "Polish", country: "Poland", country_code: "PL", locale: "pl-PL" },
  { language: "Turkish", country: "Turkey", country_code: "TR", locale: "tr-TR" },
  { language: "Vietnamese", country: "Vietnam", country_code: "VN", locale: "vi-VN" },
  { language: "Romanian", country: "Romania", country_code: "RO", locale: "ro-RO" },
  { language: "Bulgarian", country: "Bulgaria", country_code: "BG", locale: "bg-BG" },
  { language: "Catalan", country: "Spain (Catalonia)", country_code: "ES", locale: "ca-ES" },
  { language: "Thai", country: "Thailand", country_code: "TH", locale: "th-TH" },
  { language: "Danish", country: "Denmark", country_code: "DK", locale: "da-DK" },
  { language: "Finnish", country: "Finland", country_code: "FI", locale: "fi-FI" },
  { language: "Greek", country: "Greece", country_code: "GR", locale: "el-GR" },
  { language: "Hungarian", country: "Hungary", country_code: "HU", locale: "hu-HU" },
  { language: "Indonesian", country: "Indonesia", country_code: "ID", locale: "id-ID" },
  { language: "Norwegian", country: "Norway", country_code: "NO", locale: "no-NO" },
  { language: "Slovak", country: "Slovakia", country_code: "SK", locale: "sk-SK" },
  { language: "Swedish", country: "Sweden", country_code: "SE", locale: "sv-SE" },
  { language: "Malay", country: "Malaysia", country_code: "MY", locale: "ms-MY" },
  { language: "Multi-language", country: "Multiple", country_code: "MULTI", locale: "multi" },
];
