...
function InitiateCall({from,to,name,setCalling}) {
  ...
  return (
    <>
    {token ? <LiveKitConference token={token} serverUrl={serverUrl} roomName={roomName} username={name} isAdmin={true} setCalling={setCalling} />:""}
    </>
  )
}
